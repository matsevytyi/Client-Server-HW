...
public class Packet {
    ...
    public Packet(byte bSrc, byte[] bPktId, byte[] message) {
        this.bSrc = bSrc;
        this.bPktId = Arrays.copyOfRange(bPktId, 0, 8); //ensure 8 bytes length
    ...
    public byte[] toBytes() {
        ...
        answer[1] = this.bSrc;
        System.arraycopy(this.bPktId, 0, answer, 2, 8);
